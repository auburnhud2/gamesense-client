...
public class LoadConfig {
	...
	public void loadModuleDirect(String moduleLocation, Module module) throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(moduleLocation + module.getName() + ".json"));
		JsonObject moduleObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
	...
	public void loadEnabledModules() throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(enabledLocation + "Toggle" + ".json"));
		JsonObject moduleObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
	...
	public void loadDrawnModules() throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(drawnLocation + "Drawn" + ".json"));
		JsonObject moduleObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
	...
	public void loadToggleMessageModules() throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(toggleMessageLocation + "ToggleMessages" + ".json"));
		JsonObject moduleObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
	...
	public void loadCommandPrefix() throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(prefixLocation + "CommandPrefix" + ".json"));
		JsonObject mainObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
	...
	public void loadCustomFont() throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(fontLocation + "CustomFont" + ".json"));
		JsonObject mainObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
		...
		if (name != null && size != -1) {
			GameSense.INSTANCE.cFontRenderer = new CFontRenderer(new Font(name, Font.PLAIN, size),
				true, true);
	...
	public void loadFriendsList() throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(friendLocation + "Friends" + ".json"));
		JsonObject mainObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
	...
	public void loadEnemiesList() throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(enemyLocation + "Enemies" + ".json"));
		JsonObject mainObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
	...
	public void loadAutoGG() throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(fileLocation + "AutoGG" + ".json"));
		JsonObject mainObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
	...
	public void loadAutoReply() throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(fileLocation + "AutoReply" + ".json"));
		JsonObject mainObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
	...
	public void loadAutoRespawn() throws IOException {
		...
		InputStream inputStream = Files
			.newInputStream(Paths.get(fileLocation + "AutoRespawn" + ".json"));
		JsonObject mainObject = new JsonParser().parse(new InputStreamReader(inputStream))
			.getAsJsonObject();
