...
public class TabGUIModule extends HUDModule {
	...
	public void populate(Theme theme) {
		...
		TabGUIRenderer renderer = new DefaultRenderer(
			new SettingsColorScheme(clickGuiModule.enabledColor, clickGuiModule.backgroundColor,
				clickGuiModule.settingBackgroundColor, clickGuiModule.backgroundColor,
				clickGuiModule.fontColor, clickGuiModule.opacity), GameSenseGUI.HEIGHT, 5,
		...
		for (Category category : Category.values()) {
			TabGUIContainer tab = new TabGUIContainer(category.name(), renderer,
				new SettingsAnimation(clickGuiModule.animationSpeed));
