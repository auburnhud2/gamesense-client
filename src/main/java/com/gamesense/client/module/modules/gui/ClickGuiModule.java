...
public class ClickGuiModule extends Module {
	...
	public ColorSetting settingBackgroundColor = registerColor("Setting",
		new GSColor(30, 30, 30, 255));
	...
	public ModeSetting scrolling = registerMode("Scrolling", Arrays.asList("Screen", "Container"),
		"Screen");
