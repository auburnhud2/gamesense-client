...
public class ArrayListModule extends HUDModule {
	...
	public void onRender() {
		...
		list.activeModules.sort(Comparator.comparing(
			module -> -GameSense.INSTANCE.gameSenseGUI.guiInterface
				.getFontWidth(module.getName() + ChatFormatting.GRAY + " " + module.getHudInfo())));
	}
	...
	private class ModuleList implements HUDList {
		...
		public String getItem(int index) {
			...
			return (!module.getHudInfo().equals("")) ? module.getName() + ChatFormatting.GRAY + " "
				+ module.getHudInfo() : module.getName();
		}

		@Override
		public Color getItemColor(int index) {
			GSColor c = color.getValue();
			return Color.getHSBColor(c.getHue() + (color.getRainbow() ? .02f * index : 0),
				c.getSaturation(), c.getBrightness());
		}
